    ...
    <div className="h-screen overflow-y-scroll lg:overflow-y-hidden w-full bg20 lg:px-8 lg:py-4 p-2">
        <div className="flex lg:space-x-1 lg:flex-row flex-col h-full py-2 px-2 lg:pt-6 w-full justify-center">
          <div className="lg:h-full glass lg:w-2/3 h-2/3 w-full lg:pt-2 flex justify-evenly flex-wrap overflow-hidden">
            ...
            <img className="h-20 w-20 lg:h-40 lg:w-40 hover:scale-110" src="https://cdn.discordapp.com/attachments/1011518365459824660/1041980946297143326/HTML1.png" />
          ...
          <div className="flex flex-col items-center">
            ...
            <img className="h-20 w-20 lg:h-40 lg:w-40 hover:scale-110" src="https://cdn.discordapp.com/attachments/1011518365459824660/1041980946620108830/CSS1.png" />
          ...
          <div className="flex flex-col items-center">
            ...
            <img className="h-20 w-20 lg:h-40 lg:w-40 hover:scale-110" src="https://cdn.discordapp.com/attachments/1011518365459824660/1041980945361813595/JS.png" />
          ...
          <div className="flex flex-col items-center">
            ...
            <img className="h-20 w-20 lg:h-40 lg:w-40 hover:scale-110" src="https://cdn.discordapp.com/attachments/1011518365459824660/1041980945995149382/React.png" />
          ...
          <div className="flex flex-col items-center">
            ...
            <img className="h-20 w-20 lg:h-40 lg:w-40 hover:scale-110" src="https://cdn.discordapp.com/attachments/1011518365459824660/1041998955388608532/TS-removebg-preview.png" />
          ...
          <div className="flex flex-col items-center">
            ...
            <img className="h-20 w-20 lg:h-40 lg:w-40 hover:scale-110" src="https://cdn.discordapp.com/attachments/937199046211305514/1052577341701898311/st_small_507x507-pad_600x600_f8f8f8.u4-removebg-preview.png" />
